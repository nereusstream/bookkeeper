...
- [`Experimental Profile wire 与真实 old-decoder/stock-binary harness`](profile-wire/README.md)：Block D scope guard、pure codec 与610-vector authoritative corpus 已实现；真实兼容证据仍在执行，当前不是 G1 PASS。
