...
/** Secret-free service-info projection; it is a hint and never replaces persistent readiness. */
public record ProfileServiceInfoProjection(
        String bookieId,
    ...
    public ProfileServiceInfoProjection {
        ...
        endpoint = StartupFactSupport.boundedText(endpoint, 255);
