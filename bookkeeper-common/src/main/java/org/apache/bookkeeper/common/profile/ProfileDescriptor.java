...
/** Immutable safety semantics for a ledger Profile. */
public record ProfileDescriptor(
        ...
        int writeQuorumSize,
        int ackQuorumSize,
        int permanentLossBudget,
        long failureDomainPolicyId,
        long failureDomainPolicyGeneration,
        List<ProfileCapability> mandatoryCapabilities) {
    ...
    public ProfileDescriptor {
        ...
        mandatoryCapabilities = List.copyOf(
                Objects.requireNonNull(mandatoryCapabilities, "mandatoryCapabilities"));
    }
}
